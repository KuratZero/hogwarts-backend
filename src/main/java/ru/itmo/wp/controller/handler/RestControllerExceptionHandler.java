...
public class RestControllerExceptionHandler {
    ...
    public ResponseEntity<Object> onValidationException(MethodArgumentNotValidException e) {
        String errorMessage = getErrorMessage(e.getBindingResult());
        System.out.println("\n\n\n\n\n\n");
        return new ResponseEntity<>(errorMessage, new HttpHeaders(), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<Object> onValidationUserException(ValidationEntityException e) {
